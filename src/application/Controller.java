...
public class Controller {
	...
	void getAllFlights(ActionEvent event) {
		...
		try {
			...
			TextResult.appendText("Selezionare anno");
		}
		...
		try {
			...
			if (Integer.parseInt(TextDistance.getText()) > 300) {
				...
				if (bestFlights.isEmpty()) {
					...
					TextResult.appendText("L'insieme di tratte che massimizza il numero di passeggeri è:");
					TextResult.appendText("\n");
			...
			TextResult.appendText("Selezionare anno e distanza massima");
		}
